    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('users_to_notify', models.ManyToManyField(related_name='new_release_groups', through='app.Notification', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Star',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('release_group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.ReleaseGroup')),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name='starred_release_groups', through='app.Star', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='notification',
            name='release_group',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.ReleaseGroup'),
        ),
        migrations.AddField(
            model_name='notification',
            name='user',
        ...
        migrations.AlterUniqueTogether(
            name='star',
            unique_together=set([('user', 'release_group')]),
        ),
        migrations.AlterUniqueTogether(
            name='releasegroup',
            unique_together=set([('artist', 'mbid')]),
        ),
        migrations.AlterUniqueTogether(
            name='notification',
            unique_together=set([('user', 'release_group')]),

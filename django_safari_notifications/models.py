...
class DomainNames(models.Model):
    domain = models.ForeignKey(Domain, related_name="names", on_delete=models.CASCADE)
...
class Token(StatusModel):
    ...
    domain = models.ForeignKey(Domain, null=True, related_name="tokens", on_delete=models.CASCADE)
